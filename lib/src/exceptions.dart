...
class MissingDefinitionException extends FitDecoderException {
  ...
  MissingDefinitionException(this.localMessageNumber) : super('No definition found for local message number $localMessageNumber');
...
class FieldParseException extends FitDecoderException {
  ...
  FieldParseException(this.fieldName, String reason) : super('Failed to parse field "$fieldName": $reason');
...
class InsufficientDataException extends FitDecoderException {
  ...
  InsufficientDataException(this.required, this.available) : super('Required $required bytes, but only $available available');
